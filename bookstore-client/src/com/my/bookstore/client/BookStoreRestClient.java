...
public class BookStoreRestClient implements BookList {
    ...
    public List<Book> showCart() throws Exception {
    ...
    public List<Book> addBookToCart(int bookId, int count) throws Exception {
    ...
    public List<Book> displayAll() throws Exception {
